...
else
{
    ...
    if(isset($_POST['course']) && isset($_POST['academic_year']) && isset($_POST['marks_type']))
    {
        ...
        {
            $query2="INSERT INTO `academic_performance`(`student_id`, `course`, `academic_year`, `marks_type`, `sem1_score`, `sem2_score`, `sem1_kts`, `sem2_kts`, `submitted_by_admin`, `submission_date`) VALUES ('$student_id', '$course', '$academic_year', '$marks_type', '$sem_1_score', '$sem_2_score', '$sem_1_kt', '$sem_2_kt', '$admin_id', '$date')";
            $query2_run=mysqli_query($connect,$query2);
            if(mysqli_affected_rows($connect)>0)
            {
                $query21="INSERT INTO `system_logs`(`admin_id`, `module`, `action`, `time`) VALUES ('$admin_id', 'academic performance', 'add', '$date')";
                ...
                if(isset($_POST['submit_and_goback']))
                {
                    $msg='<center><div class="alert alert-success alert-dismissible" role="alert">
                          ...
                          Academic performance submitted successfully.
                        </div></center>';
                ...
                else
                {
                    $msg='<center><div class="alert alert-success alert-dismissible" role="alert">
                        ...
                        <center><div class="alert alert-info alert-dismissible" role="alert">
                          ...
                          You can add another Academic performance now.
                        </div></center>';
                }
            ...
            else
            {
                $msg='<center><div class="alert alert-danger alert-dismissible" role="alert">
                          ...
                          Unable to submit Academic performance!
                        </div></center>';
            }
        }
        else
            ...
            <div class="wrapper container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Add Academic Performance</div>
                ...
                ?>
                            <?php if(isset($msg)){echo $msg; } ?>
                                <form class="form-horizontal" action="add_academic_performance?<?php echo $_SERVER['QUERY_STRING']; ?>" method="POST">
                                    <br/>
                                ...
                                <?php
                                        ...
                                        {
                                ?>  
                                                <option value="<?php echo $courses['value']; ?>"> <?php echo $courses['description']; ?> </option>
                                <?php
                                        }
                                ?>                                   
                                            </select>
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <?php
                                                    ...
                                                    {
                                            ?>  
                                                        <option value="<?php echo $marks_type['value']; ?>"> <?php echo $marks_type['description']; ?> </option>
                                            <?php
                                                    }
                                            ?>                                   
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="sem_1_score" placeholder="Sem 1 score">
                                        </div>
                                        <label class="col-sm-2 control-label">Sem 2 score</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="sem_2_score" placeholder="Sem 2 score">
                                        </div>
                                    </div>
                                    <hr class="dotted">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="number" class="form-control" min="0" name="sem_1_kt" placeholder="">
                                        </div>
                                        <label class="col-sm-2 control-label">How many KT's in sem 2</label>
                                        <div class="col-sm-3">
                                            <input type="number" class="form-control" min="0" name="sem_2_kt" placeholder="">
                                        </div>
                                    </div>
                                    <hr class="dotted">
                                    <div class="form-group">
