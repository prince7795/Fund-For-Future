...
else
{
    ...
    if(isset($_POST['referral_name']) && isset($_POST['referral_type']))
    {
        ...
        {
            $query2="INSERT INTO `referral_details`(`student_id`, `name_of_referral`, `mobile`, `email`, `type`, `submitted_by_admin`, `submission_date`) VALUES ('$student_id', '$referral_name', '$refferal_mobile', '$refferal_email', '$referral_type', '$admin_id', '$date')";
            $query2_run=mysqli_query($connect,$query2);
            
            if(mysqli_affected_rows($connect)>0)
            {
                $query21="INSERT INTO `system_logs`(`admin_id`, `module`, `action`, `affected_student`, `affected_kp`, `affected_decoding`, `affected_event`, `time`) VALUES ('$admin_id', 'referral details', 'add', '$student_id', '', '', '', '$date')";
            ...
            else
            {
                $msg='<center><div class="alert alert-danger alert-dismissible" role="alert">
                          ...
                          Unable to submit Referral details!
                        </div></center>';
            }
        }
        else
    ...
    $query3="select * from referral_details where student_id='$student_id'";
        ...
        <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Add New Referral Details</div>
            ...
            ?>
                            <?php if(isset($msg)){echo $msg; } ?>
                                <form class="form-horizontal" action="add_referral_details?<?php echo $_SERVER['QUERY_STRING']; ?>" method="POST">
                                    <br/>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Name of Referral*</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" name="referral_name" placeholder="Full Name*" required>
                                        </div>
                                    </div>
                                    <hr class="dotted">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="number" class="form-control" min="0" name="refferal_mobile" placeholder="Mobile">
                                        </div>
                                        <label class="col-sm-2 control-label">Email</label>
                                        <div class="col-sm-3">
                                            <input type="email" class="form-control" name="refferal_email" placeholder="Email">
                                        </div>
                                    </div>
                                    <hr class="dotted">
                                    <div class="form-group">
                                ...
                                <?php
                                        ...
                                        {
                                ?>
                                                <option value="<?php echo $referral_type['value']; ?>"> <?php echo $referral_type['description']; ?> </option>
                                <?php
                                        }
                                ?>
                                            </select>
            ...
            ?>
                            <center>
                                <div class="alert alert-success alert-dismissible" role="alert">
                                    <h3>This student have already submitted referral details.</h3>
                                    <a href="edit_referral_details?student_id=<?= $student_id; ?>&&student_code="><h4>You can edit the same by clicking here.</h4></a>
                                </div>
                            </center>
            <?php 
                        }
