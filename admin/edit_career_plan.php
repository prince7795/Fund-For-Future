...
else
{
    ...
    {
        $career_id=str_replace("'", "\'", $_GET['career_id']);
    }
    ...
    if(isset($_POST['career_plan']) && isset($_POST['earn_and_learn']) && isset($_POST['parent_contribution']))
    {
        ...
        {
            $query2="UPDATE `career_plan` SET `career_plan`='$career_plan', `career_explanation`='$career_explanation',
												`earn_and_learn`='$earn_and_learn', `earn_and_learn_explanation`='$earn_and_learn_yes',
												`parent_contribution`='$parent_contribution', `parent_contribution_explanation`='$parent_contribution_yes', 
            ...
            if(mysqli_affected_rows($connect)>0)
            {
                $query21="INSERT INTO `system_logs`(`admin_id`, `module`, `action`, `time`)
							VALUES ('$admin_id', 'career plan', 'edit', '$date')";
    ...
    $query3="select * from career_plan where id='$career_id' and student_id='$student_id'";
        ...
        <section class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Edit Career plan</div>
            ...
            <?php 
                if($student_rows==1)
                {
                    ...
                    {
                        if($career_plan_rows==1)
                        {
            ?>
                            <?php if(isset($msg)){echo $msg; } ?>
                                <form class="form-horizontal" action="edit_career_plan?<?php echo $_SERVER['QUERY_STRING']; ?>" method="POST">
                                    <br/>
                                ...
                                <?php
                                        ...
                                        {
                                ?>  
                                                <option value="<?php echo $career_option['value']; ?>" <?php if(!empty($existing_data['career_plan']) && $existing_data['career_plan']==$career_option['value']){ echo 'selected'; } ?>> <?php echo $career_option['description']; ?> </option>
                                <?php
                                        }
                                ?>                                   
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea class="form-control" name="career_explanation" placeholder="Explanation"><?= $existing_data['career_explanation']; ?></textarea>
                                        </div>
                                    </div>
                                    <hr class="dotted">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group" id="earn_and_learn_yes_div" style="display: none;">
                                        ...
                                        <div class="col-sm-7">
                                            <textarea class="form-control" name="earn_and_learn_yes" placeholder="Explanation*"><?= $existing_data['earn_and_learn_explanation']; ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control chosen-select" id="parent_contribution" name="parent_contribution" data-placeholder=""  onchange="show_parent_contribution();" required>
                                                <option></option>
                                                <option value="Yes" <?php if(!empty($existing_data['parent_contribution']) && $existing_data['parent_contribution']=='Yes'){ echo 'selected'; } ?>>Yes</option>
                                                <option value="No" <?php if(!empty($existing_data['parent_contribution']) && $existing_data['parent_contribution']=='No'){ echo 'selected'; } ?>>No</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group" id="parent_contribution_yes_div" style="display: none;">
                                        <label class="col-sm-2 control-label"></label>
                                        <div class="col-sm-7">
                                            <textarea class="form-control" name="parent_contribution_yes" placeholder="Explanation*"><?= $existing_data['parent_contribution_explanation']; ?></textarea>
            ...
            ?>
                            <center>
                                <div class="alert alert-danger alert-dismissible" role="alert">
                                    <h3>No carrer plan record found for this student.</h3>
                                </div>
                            </center>
            <?php 
                        }
            ...
            ?>
                    <center>
                        <div class="alert alert-danger alert-dismissible" role="alert">
                            <h3>No student found with this ID.</h3>h4>
                        </div>
                    </center>
            <?php
                }
